...
/// Slug returned by [`DnsUdpParser`]'s `parser_kind()` —
/// the [`ParserKind::DnsUdp`](crate::ParserKind::DnsUdp) slug.
///
/// Stability: locked from 0.8 forward.
pub const PARSER_KIND_UDP: &str = "dns-udp";

/// Slug returned by [`DnsTcpParser`]'s `parser_kind()` —
/// the [`ParserKind::DnsTcp`](crate::ParserKind::DnsTcp) slug.
///
/// Stability: locked from 0.8 forward.
