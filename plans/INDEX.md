...
| [`50-deferred-catchup.md`](./50-deferred-catchup.md) | InnerGre, FlowLabel, AutoDetectEncap, IPv6 frags, etc. | 🚧 50.1, 50.2, 50.3, 50.4 ✅ here; 50.6 ✅ (lives in netring). 50.5 IPv6 frag reassembly deferred. |
